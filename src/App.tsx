...
import { IDSInput } from "./widgets/IDSInput";
  ...
  useEffect(() => {
    const suppressResizeObserverListener = (e: ErrorEvent) => {
      if (e.message === "ResizeObserver loop completed with undelivered notifications.") {
        ...
        if (e.message.includes('ContentControl')) {
          ...
          console.log(`${e.message} is not handled`);
        }
    }

    };
    window.addEventListener("error", suppressResizeObserverListener);
    return () => window.removeEventListener("error", suppressResizeObserverListener);
  }, []);
